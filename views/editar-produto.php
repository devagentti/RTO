...
<div class="container">
	...
	<form method="POST" enctype="multipart/form-data" action="<?php echo BASE_URL; ?>anuncios/editar?id=<?php echo $info['id']; ?>">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="foto_item">
						...
						<a href="<?php echo BASE_URL; ?>anuncios/excluirFoto?id=<?php echo $foto['id']; ?>" class="btn btn-default">Excluir Imagem</a>
					</div>
					<?php endforeach; ?>
				</div>
			</div>
